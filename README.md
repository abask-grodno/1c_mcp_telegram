...
Расширение 1c_mcp_custom_query и документация по установке доступно по адресу [![GitHub](https://img.shields.io/badge/GitHub-Repository-black)](https://github.com/abask-grodno/1c_mcp_custom_query)
Основано на [![Original Project](https://img.shields.io/badge/Original-1C_MCP-blue)](https://github.com/vladimir-kharin/1c_mcp) 
